...
.bi-chat-launcher {
  ...
  color: var(--bi-text, #e8e8e8);
  border: 1px solid rgba(255,255,255,0.25);
  border-radius: 999px;
  font-family: var(--bi-font-mono, 'JetBrains Mono', monospace);
  font-size: 11px;
  font-weight: 500;
...
.bi-chat-launcher:hover {
  border-color: var(--bi-teal-bright, #16A2AE);
  color: var(--bi-teal-bright, #16A2AE);
...
.bi-chat-launcher__dot {
  ...
  height: 6px;
  border-radius: 50%;
  background: var(--bi-teal-bright, #16A2AE);
  box-shadow: 0 0 12px var(--bi-teal-bright, #16A2AE);
...
.bi-chat-panel {
  ...
  box-shadow:
    ...
    0 0 0 1px rgba(22, 162, 174, 0.04),
...
.bi-chat-avatar {
  ...
  height: 38px;
  border-radius: 50%;
  background: linear-gradient(135deg, var(--bi-teal-bright, #16A2AE), var(--bi-teal, #0F6F78));
  display: flex;
  align-items: center;
  justify-content: center;
  font-family: var(--bi-font-sans, 'Inter', sans-serif);
  font-size: 16px;
  font-weight: 600;
  color: #0a0a0a;
...
.bi-chat-status__dot {
  ...
  border-radius: 50%;
  background: var(--bi-teal-bright, #16A2AE);
  box-shadow: 0 0 8px var(--bi-teal-bright, #16A2AE);
}
.bi-chat-close {
  width: 32px;
  height: 32px;
...
.bi-chat-msg.user {
  align-self: flex-end;
  background: rgba(22, 162, 174, 0.12);
  border: 1px solid rgba(22, 162, 174, 0.3);
  color: var(--bi-text, #e8e8e8);
...
.bi-chat-msg.summary {
  align-self: stretch;
  max-width: 100%;
  background: rgba(22, 162, 174, 0.06);
  border: 1px solid rgba(22, 162, 174, 0.2);
  color: var(--bi-text, #e8e8e8);
  font-family: var(--bi-font-mono, 'JetBrains Mono', monospace);
  font-size: 11px;
...
.bi-chat-submit {
  ...
  background: var(--bi-teal-bright, #16A2AE);
  color: #0a0a0a;
  border: 1px solid var(--bi-teal-bright, #16A2AE);
  border-radius: 999px;
  font-family: var(--bi-font-mono, 'JetBrains Mono', monospace);
  font-size: 10px;
  font-weight: 600;
...
.bi-chat-submit:hover {
  background: var(--bi-teal, #0F6F78);
  border-color: var(--bi-teal, #0F6F78);
...
.bi-chat-pick:hover {
  border-color: var(--bi-teal-bright, #16A2AE);
  background: rgba(22, 162, 174, 0.04);
  transform: translateX(2px);
}
...
.bi-chat-rec-label.alt { color: var(--bi-teal, #0F6F78); }
.bi-chat-rec-list {
  list-style: none;
  padding: 0;
  margin: 0;
...
.bi-chat-rec-list.alt li::before { background: var(--bi-teal, #0F6F78); }
.bi-chat-rec-divider {
  border: 0;
  border-top: 1px solid rgba(255,255,255,0.08);
  margin: 0;
...
/* ── Standalone auto-init (classic script, not an ES module) ── */
window.BIChatbot = Chatbot;
(function () {
  function init() {
    if (window.__biChatbot) return;
    window.__biChatbot = new Chatbot({ launcherLabel: 'Start a build' });
  }
